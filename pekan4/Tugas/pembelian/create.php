...
<form method="POST" action="proses.php">
    <div class="form-group row mt-2">
        ...
        <div class="col-8">
            <div class="input-group">
                <input id="nomor" name="nomor" type="date" class="form-control" value="">
            </div>
        </div>
    </div>
    ...
    <div class="form-group row mt-2">
        ...
        <div class="col-8">
            <div class="input-group">
                <input id="jumlah" name="iuran" value="" type="text" class="form-control">
            </div>
        </div>
    </div>
    ...
    <div class="form-group row mt-2">
        ...
        <div class="col-8">
            <div class="input-group">
                <input id="harga" name="iuran" value="" type="text" class="form-control">
            </div>
        </div>
    </div>
    ...
    <div class="form-group row mt-2">
        ...
        <div class="col-8">
            <div class="input-group">
                <input id="vendor_id" name="iuran" value="" type="text" class="form-control">
            </div>
        </div>
    </div>
